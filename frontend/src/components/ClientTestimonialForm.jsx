      ...
      <div className="space-y-5">
        ...
        <div>
          ...
          <textarea
            ...
            rows="5"
            className={`w-full px-4 py-3 bg-gray-800/50 border rounded-lg 
              focus:ring-2 focus:ring-purple-500 outline-none resize-none transition
        ...
        <button
          ...
          disabled={loading}
          className="w-full bg-gradient-to-r from-purple-600 to-pink-600 py-4 rounded-lg 
            font-semibold hover:shadow-lg hover:shadow-purple-500/50 transition-all
...
// ============ EXPORT THIS - Use as button trigger only ============
const ClientTestimonialForm = ({ onClose, onSuccess }) => {
  const [showModal, setShowModal] = useState(false);

  return (
    <>
      {/* Just the button - testimonials displayed in App.jsx */}
